...
| Phase | Sub-product         | Status | Subtasks done |
| ----- | ------------------- | ------ | ------------- |
| 0     | Repository Init     | ✅     | —             |
| 1     | Local Task System   | ⬜     | 0 / 9         |
| 2     | Durable Anchoring   | ⬜     | 0 / 7         |
| 3     | Thread View         | ⬜     | 0 / 6         |
| 4     | AI Agent Contract   | ⬜     | 0 / 5         |
| 5     | AI Change Preview   | ⬜     | 0 / 4         |
| 6     | Git-Aware Recovery  | ⬜     | 0 / 4         |
| 7     | Scale & Marketplace | ⬜     | 0 / 6         |
